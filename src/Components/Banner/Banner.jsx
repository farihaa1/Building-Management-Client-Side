    ...
    const banner = [
        {
          ...
          title: "Experience the ultimate luxurious living in the heart of the city, surrounded by convenience and style.",
          callToAction: {
        ...
        },
        {
          ...
          title: "Discover modern apartments with premium amenities designed for your comfort and lifestyle needs.",
          callToAction: {
            text: "View Details",
            link: "/details",
          },
        ...
        },
        {
          ...
          title: "Enjoy the perfect blend of sophistication and comfort in a modern apartment overlooking the city skyline.",
          callToAction: {
        ...
        },
        {
          ...
          title: "Explore elegant apartments designed for every lifestyle, offering luxury at an affordable price.",
          callToAction: {
        ...
        },
        {
          id: 5,
          heading: "Urban Oasis",
          title: "Live, work, and play in perfect harmony at an urban oasis designed for a modern lifestyle.",
          callToAction: {
            text: "Discover More",
            link: "/discover",
          },
    ...
    <div>
      ...
      >
        {banner.map((item) => (
          ...
          <div
            className="banner-slide w-full relative px-12"
            style={{
